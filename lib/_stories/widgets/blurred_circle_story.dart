...
class BlurredCircleStory extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final isCustomBlur = context.knobs.boolean(
      label: 'Custom Blur',
      initial: true,
    );
    ...
    final offsetX = context.knobs.slider(
      label: 'Offset X',
      initial: 0,
      min: -200,
      max: 200,
    );
    final offsetY = context.knobs.slider(
      label: 'Offset Y',
      initial: 0,
      min: -200,
      max: 200,
    );
    final radius = context.knobs.slider(
      label: 'Radius',
      initial: 128,
      min: 10,
      max: 300,
